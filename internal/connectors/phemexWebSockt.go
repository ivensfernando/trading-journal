...
//	query := "currency=USDT"
//
//	logger.Infof("Path: %s, Query: %s", path, query)
//
...
//	}
//
//	logger.Infof("Order accepted: %s", resp.Msg)
//	return nil
//}
//
//// Close LONG position
...
//
//	b, _ := json.Marshal(body)
//	logger.WithFields(map[string]interface{}{"qty: %s": qty}).Info("Closing LONG ETHUSDT with ")
//	resp, err := c.doRequest(http.MethodPost, path, "", b)
//	if err != nil {
//		return err
//	}
...
//	}
//
//	logger.Infof("Position closed: %s", resp.Msg)
//	return nil
//}
//
////// -----------------------------------------
